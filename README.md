...
  <img src="https://img.shields.io/badge/CLEARANCE-TOP%20SECRET-ff0055?style=for-the-badge&logo=codeforces&logoColor=white" alt="Clearance">

  <img src="https://img.shields.io/badge/ANOMALIES_DETECTED-660-00f3ff?style=for-the-badge&logo=hackthebox&logoColor=white" alt="Anomalies">

  <img src="https://img.shields.io/badge/AESTHETIC-CYBER%20RESEARCH-7b2cbf?style=for-the-badge&logo=react&logoColor=white" alt="Style">
...
graph TD
    ...
    A[Lab Intern] --> B{Core Fundamentals}

    B --> C[System Architecture<br/>Win / Nix]
    B --> D[Network Topologies]

    C --> E((Offensive Research))
    D --> F((Defensive Forensics))

    E --> G[Web Protocol Anomalies]
    F --> H[Malware Containment & SOC]

    G --> I[Project: Ascendant<br/>Endgame]
    H --> I

    style A fill:#00f3ff,stroke:#000,stroke-width:2px,color:#000
    style I fill:#ff0055,stroke:#000,stroke-width:2px,color:#fff
```
...
<a id="arc-01-prologue-the-awakening"></a>
## 🧪 ARC 01: PROLOGUE: THE AWAKENING

<details>
<summary><b>📋 Access Lab Notes</b></summary>
...
<a id="arc-02-forbidden-kernel"></a>
...
<a id="arc-04-shadow-recon-&-osint"></a>
...
<a id="arc-05-web-exploitation-grind"></a>
...
<a id="arc-07-root-escalation-linux"></a>
...
<a id="arc-09-nebula-cloud-&-docker"></a>
...
<a id="arc-10-blue-ghost-investigation"></a>
...
<a id="arc-11-code-breakers-&-malware-lab"></a>
...
<a id="arc-12-rookie-arena-easy-ctfs"></a>
...
<a id="arc-13-elite-gauntlet-medium-ctfs"></a>
...
<a id="arc-14-endgame-hard-&-insane-boss-raids"></a>
...
<a id="bonus-arc-secret-weapons-&-reinforcements"></a>
